...
namespace MyStore.Migrations
{
    ...
    [Migration("20230529111246_multiTenancy")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyStore.Customers.Customer", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("MyStore.Products.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MyStore.Products.ProductView", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppProductViews", (string)null);
                });
            ...
            modelBuilder.Entity("MyStore.Products.ProductView", b =>
                {
                    b.HasOne("MyStore.Customers.Customer", "Customer")
                        .WithMany("ProductViews")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyStore.Products.Product", "Product")
                        .WithMany("ProductViews")
